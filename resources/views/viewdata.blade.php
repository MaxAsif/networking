...
<div class="w3-main" style="margin-left:300px">
  ...
  <header id="portfolio">
    ...
    <div class="w3-section w3-bottombar w3-padding-16">
      ...
      <button class="w3-button w3-white">TAG1</button>
      <button class="w3-button w3-white w3-hide-small">TAG2</button>
      <button class="w3-button w3-white w3-hide-small">TAG3</button>
    </div>
    </div>
  </header>
